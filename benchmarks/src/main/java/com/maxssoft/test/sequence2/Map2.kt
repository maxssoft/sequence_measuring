...
class Map2 {
    ...
    fun map2_100_rec_sequence(blackHole: Blackhole) {
        map2_sequence(originCollection_100).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map2_1000_rec_sequence(blackHole: Blackhole) {
        map2_sequence(originCollection_1_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }
    ...
    fun map2_50000_rec_sequence(blackHole: Blackhole) {
        map2_sequence(originCollection_50_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map2_100000_rec_sequence(blackHole: Blackhole) {
        map2_sequence(originCollection_100_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map2_100_rec_collection(blackHole: Blackhole) {
        map2_collection(originCollection_100).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map2_1000_rec_collection(blackHole: Blackhole) {
        map2_collection(originCollection_1_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }
    ...
    fun map2_50000_rec_collection(blackHole: Blackhole) {
        map2_collection(originCollection_50_000).collectSum(blackHole)
    }

    @Benchmark
    fun map2_100000_rec_collection(blackHole: Blackhole) {
        map2_collection(originCollection_100_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map2_100_rec_stream(blackHole: Blackhole) {
        map2_stream(originCollection_100).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map2_1000_rec_stream(blackHole: Blackhole) {
        map2_stream(originCollection_1_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }
    ...
    fun map2_50000_rec_stream(blackHole: Blackhole) {
        map2_stream(originCollection_50_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map2_100000_rec_stream(blackHole: Blackhole) {
        map2_stream(originCollection_100_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }
