...
class Map5 {
    ...
    fun map5_100_rec_sequence(blackHole: Blackhole) {
        map5_sequence(originCollection_100).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map5_1000_rec_sequence(blackHole: Blackhole) {
        map5_sequence(originCollection_1_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }
    ...
    fun map5_50000_rec_sequence(blackHole: Blackhole) {
        map5_sequence(originCollection_50_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map5_100000_rec_sequence(blackHole: Blackhole) {
        map5_sequence(originCollection_100_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map5_100_rec_collection(blackHole: Blackhole) {
        map5_collection(originCollection_100).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map5_1000_rec_collection(blackHole: Blackhole) {
        map5_collection(originCollection_1_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }
    ...
    fun map5_50000_rec_collection(blackHole: Blackhole) {
        map5_collection(originCollection_50_000).collectSum(blackHole)
    }

    @Benchmark
    fun map5_100000_rec_collection(blackHole: Blackhole) {
        map5_collection(originCollection_100_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map5_100_rec_stream(blackHole: Blackhole) {
        map5_stream(originCollection_100).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map5_1000_rec_stream(blackHole: Blackhole) {
        map5_stream(originCollection_1_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }
    ...
    fun map5_50000_rec_stream(blackHole: Blackhole) {
        map5_stream(originCollection_50_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map5_100000_rec_stream(blackHole: Blackhole) {
        map5_stream(originCollection_100_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }
