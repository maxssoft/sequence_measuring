...
class Map3 {
    ...
    fun map3_100_rec_sequence(blackHole: Blackhole) {
        map3_sequence(originCollection_100).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map3_1000_rec_sequence(blackHole: Blackhole) {
        map3_sequence(originCollection_1_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map3_10000_rec_sequence(blackHole: Blackhole) {
        map3_sequence(originCollection_10_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map3_50000_rec_sequence(blackHole: Blackhole) {
        map3_sequence(originCollection_50_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map3_100000_rec_sequence(blackHole: Blackhole) {
        map3_sequence(originCollection_100_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map3_100_rec_collection(blackHole: Blackhole) {
        map3_collection(originCollection_100).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map3_1000_rec_collection(blackHole: Blackhole) {
        map3_collection(originCollection_1_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map3_10000_rec_collection(blackHole: Blackhole) {
        map3_collection(originCollection_10_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map3_50000_rec_collection(blackHole: Blackhole) {
        map3_collection(originCollection_50_000).collectSum(blackHole)
    }

    @Benchmark
    fun map3_100000_rec_collection(blackHole: Blackhole) {
        map3_collection(originCollection_100_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map3_100_rec_stream(blackHole: Blackhole) {
        map3_stream(originCollection_100).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map3_1000_rec_stream(blackHole: Blackhole) {
        map3_stream(originCollection_1_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map3_10000_rec_stream(blackHole: Blackhole) {
        map3_stream(originCollection_10_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map3_50000_rec_stream(blackHole: Blackhole) {
        map3_stream(originCollection_50_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun map3_100000_rec_stream(blackHole: Blackhole) {
        map3_stream(originCollection_100_000).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }
