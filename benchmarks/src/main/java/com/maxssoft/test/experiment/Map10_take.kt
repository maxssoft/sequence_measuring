...
import com.maxssoft.func.map10_collection_take
import com.maxssoft.func.map10_sequence_int
import com.maxssoft.func.map10_sequence_take
...
/*
    ...
    fun map10_100_rec_sequence(blackHole: Blackhole) {
        return map10_sequence_take(originCollection_100).collectBlackHole(blackHole)
    }

    @Benchmark
    fun map10_1000_rec_sequence(blackHole: Blackhole) {
        return map10_sequence_take(originCollection_1_000).collectBlackHole(blackHole)
    }

    @Benchmark
    fun map10_10000_rec_sequence(blackHole: Blackhole) {
        return map10_sequence_take(originCollection_10_000).collectBlackHole(blackHole)
    }
*/

    @Benchmark
    fun map10_100000_rec_sequence(blackHole: Blackhole) {
        return map10_sequence_take(originCollection_100_000).collectBlackHole(blackHole)
    }

/*
    @Benchmark
    fun map10_100_rec_collection(blackHole: Blackhole) {
        return map10_collection_take(originCollection_100).collectBlackHole(blackHole)
    }

    @Benchmark
    fun map10_1000_rec_collection(blackHole: Blackhole) {
        return map10_collection_take(originCollection_1_000).collectBlackHole(blackHole)
    }

    @Benchmark
    fun map10_10000_rec_collection(blackHole: Blackhole) {
        return map10_collection_take(originCollection_10_000).collectBlackHole(blackHole)
    }
*/

    @Benchmark
    fun map10_100000_rec_collection(blackHole: Blackhole) {
        return map10_collection_take(originCollection_100_000).collectBlackHole(blackHole)
    }
