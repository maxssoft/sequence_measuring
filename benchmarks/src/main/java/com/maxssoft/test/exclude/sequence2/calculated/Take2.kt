...
/*
    ...
    fun take2_90_percentage_1000_rec_sequence(blackHole: Blackhole) {
        take2_sequence(originCollection_1_000, 90).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun take2_90_percentage_10000_rec_sequence(blackHole: Blackhole) {
        take2_sequence(originCollection_10_000, 90).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun take2_90_percentage_50000_rec_sequence(blackHole: Blackhole) {
        take2_sequence(originCollection_50_000, 90).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun take2_90_percentage_100000_rec_sequence(blackHole: Blackhole) {
        take2_sequence(originCollection_100_000, 90).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun take2_90_percentage_100_rec_stream(blackHole: Blackhole) {
        take2_stream(originCollection_100, 90).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun take2_90_percentage_1000_rec_stream(blackHole: Blackhole) {
        take2_stream(originCollection_1_000, 90).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun take2_90_percentage_10000_rec_stream(blackHole: Blackhole) {
        take2_stream(originCollection_10_000, 90).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun take2_90_percentage_50000_rec_stream(blackHole: Blackhole) {
        take2_stream(originCollection_50_000, 90).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun take2_90_percentage_100000_rec_stream(blackHole: Blackhole) {
        take2_stream(originCollection_100_000, 90).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun take2_90_percentage_100_rec_collection(blackHole: Blackhole) {
        take2_collection(originCollection_100, 90).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun take2_90_percentage_1000_rec_collection(blackHole: Blackhole) {
        take2_collection(originCollection_1_000, 90).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun take2_90_percentage_10000_rec_collection(blackHole: Blackhole) {
        take2_collection(originCollection_10_000, 90).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun take2_90_percentage_50000_rec_collection(blackHole: Blackhole) {
        take2_collection(originCollection_50_000, 90).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }
...
*/
    ...
    fun take2_10_percentage_100_rec_sequence(blackHole: Blackhole) {
        take2_sequence(originCollection_100, 10).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun take2_10_percentage_1000_rec_sequence(blackHole: Blackhole) {
        take2_sequence(originCollection_1_000, 10).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun take2_10_percentage_10000_rec_sequence(blackHole: Blackhole) {
        take2_sequence(originCollection_10_000, 10).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun take2_10_percentage_50000_rec_sequence(blackHole: Blackhole) {
        take2_sequence(originCollection_50_000, 10).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun take2_10_percentage_100000_rec_sequence(blackHole: Blackhole) {
        take2_sequence(originCollection_100_000, 10).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun take2_10_percentage_100_rec_stream(blackHole: Blackhole) {
        take2_stream(originCollection_100, 10).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun take2_10_percentage_1000_rec_stream(blackHole: Blackhole) {
        take2_stream(originCollection_1_000, 10).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun take2_10_percentage_10000_rec_stream(blackHole: Blackhole) {
        take2_stream(originCollection_10_000, 10).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun take2_10_percentage_50000_rec_stream(blackHole: Blackhole) {
        take2_stream(originCollection_50_000, 10).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun take2_10_percentage_100000_rec_stream(blackHole: Blackhole) {
        take2_stream(originCollection_100_000, 10).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun take2_10_percentage_100_rec_collection(blackHole: Blackhole) {
        take2_collection(originCollection_100, 10).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun take2_10_percentage_1000_rec_collection(blackHole: Blackhole) {
        take2_collection(originCollection_1_000, 10).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun take2_10_percentage_10000_rec_collection(blackHole: Blackhole) {
        take2_collection(originCollection_10_000, 10).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun take2_10_percentage_50000_rec_collection(blackHole: Blackhole) {
        take2_collection(originCollection_50_000, 10).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun take2_10_percentage_100000_rec_collection(blackHole: Blackhole) {
        take2_collection(originCollection_100_000, 10).collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }
}
