...
/*
    ...
    fun groupBy2_90_percentage_1000_rec_sequence(blackHole: Blackhole) {
        groupBy2_sequence_90(originCollection_1_000).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun groupBy2_90_percentage_10000_rec_sequence(blackHole: Blackhole) {
        groupBy2_sequence_90(originCollection_10_000).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun groupBy2_90_percentage_50000_rec_sequence(blackHole: Blackhole) {
        groupBy2_sequence_90(originCollection_50_000).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun groupBy2_90_percentage_100000_rec_sequence(blackHole: Blackhole) {
        groupBy2_sequence_90(originCollection_100_000).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun groupBy2_90_percentage_100_rec_stream(blackHole: Blackhole) {
        groupBy2_stream_90(originCollection_100).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun groupBy2_90_percentage_1000_rec_stream(blackHole: Blackhole) {
        groupBy2_stream_90(originCollection_1_000).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun groupBy2_90_percentage_10000_rec_stream(blackHole: Blackhole) {
        groupBy2_stream_90(originCollection_10_000).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun groupBy2_90_percentage_50000_rec_stream(blackHole: Blackhole) {
        groupBy2_stream_90(originCollection_50_000).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun groupBy2_90_percentage_100000_rec_stream(blackHole: Blackhole) {
        groupBy2_stream_90(originCollection_100_000).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun groupBy2_90_percentage_100_rec_collection(blackHole: Blackhole) {
        groupBy2_collection_90(originCollection_100).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun groupBy2_90_percentage_1000_rec_collection(blackHole: Blackhole) {
        groupBy2_collection_90(originCollection_1_000).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun groupBy2_90_percentage_10000_rec_collection(blackHole: Blackhole) {
        groupBy2_collection_90(originCollection_10_000).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun groupBy2_90_percentage_50000_rec_collection(blackHole: Blackhole) {
        groupBy2_collection_90(originCollection_50_000).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }
...
*/
    ...
    fun groupBy2_10_percentage_100_rec_sequence(blackHole: Blackhole) {
        groupBy2_sequence_10(originCollection_100).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun groupBy2_10_percentage_1000_rec_sequence(blackHole: Blackhole) {
        groupBy2_sequence_10(originCollection_1_000).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun groupBy2_10_percentage_10000_rec_sequence(blackHole: Blackhole) {
        groupBy2_sequence_10(originCollection_10_000).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun groupBy2_10_percentage_50000_rec_sequence(blackHole: Blackhole) {
        groupBy2_sequence_10(originCollection_50_000).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun groupBy2_10_percentage_100000_rec_sequence(blackHole: Blackhole) {
        groupBy2_sequence_10(originCollection_100_000).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun groupBy2_10_percentage_100_rec_stream(blackHole: Blackhole) {
        groupBy2_stream_10(originCollection_100).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun groupBy2_10_percentage_1000_rec_stream(blackHole: Blackhole) {
        groupBy2_stream_10(originCollection_1_000).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun groupBy2_10_percentage_10000_rec_stream(blackHole: Blackhole) {
        groupBy2_stream_10(originCollection_10_000).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun groupBy2_10_percentage_50000_rec_stream(blackHole: Blackhole) {
        groupBy2_stream_10(originCollection_50_000).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun groupBy2_10_percentage_100000_rec_stream(blackHole: Blackhole) {
        groupBy2_stream_10(originCollection_100_000).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun groupBy2_10_percentage_100_rec_collection(blackHole: Blackhole) {
        groupBy2_collection_10(originCollection_100).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun groupBy2_10_percentage_1000_rec_collection(blackHole: Blackhole) {
        groupBy2_collection_10(originCollection_1_000).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun groupBy2_10_percentage_10000_rec_collection(blackHole: Blackhole) {
        groupBy2_collection_10(originCollection_10_000).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun groupBy2_10_percentage_50000_rec_collection(blackHole: Blackhole) {
        groupBy2_collection_10(originCollection_50_000).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }

    @Benchmark
    fun groupBy2_10_percentage_100000_rec_collection(blackHole: Blackhole) {
        groupBy2_collection_10(originCollection_100_000).keys.collectSum(blackHole)
        blackHole.consume(memoryConsumer.read())
    }
